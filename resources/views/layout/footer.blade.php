       <div class="container" style="margin-top: 5px">
           <div class="row" style="margin: auto">
               <div class="col-md-12 text-primary" style="background-color:#CCCCCC;">
                   ...
                   <a href="http://localhost/laravelProject/TaskPushSys/public/"> <b style="margin-left: 20px;">管理平台</b></a>
               </div>
           </div>
       </div>
    </body>
